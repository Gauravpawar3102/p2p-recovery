...
export function SmartAccountDisplay({
  network,
  p2pUserWallet,
  onSmartAccountChange,
}: SmartAccountDisplayProps) {
  ...
  const handleDeploy = async () => {
    if (!wallet || !smartAccountAddress) {
      setDeployError(
        'Wallet not connected or smart account address not available',
      );
      return;
    }
  ...
  return (
    <div className='bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-xl p-5 md:p-6 shadow-soft'>
      ...
      <p className='text-sm text-neutral-600 dark:text-neutral-400 mb-6'>
        Your smart account address derived from the factory and your P2P.ME user
        wallet
      </p>
      ...
      {p2pUserWallet && (
        <div className='mb-6'>
          ...
          <div
            className='flex items-center gap-2 p-3 bg-blue-50 dark:bg-blue-900/20 border rounded-lg'
            style={{ borderColor: '#8984D9' }}>
