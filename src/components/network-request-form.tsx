    ...
    <div
      ...
      <div className='mb-4 sm:mb-5'>
        <div>
          ...
          <h2 className='text-base sm:text-lg md:text-xl font-semibold text-neutral-900 dark:text-neutral-50 mt-2'>
            Request New Network
          </h2>
        </div>
      </div>
          ...
          <div className='flex flex-col gap-2 p-3 sm:p-4 bg-success-light dark:bg-success-dark/20 border border-success/30 rounded-lg text-success-dark dark:text-success-light'>
            <div className='flex items-start sm:items-center gap-2 sm:gap-3'>
              ...
              <p className='text-xs sm:text-sm font-medium leading-relaxed'>
                {isNewRequest
                  ? 'Network request submitted successfully!'
                  : `You and ${requestCount! - 1} ${requestCount! - 1 === 1 ? 'other has' : 'others have'} requested to add this network`}
              </p>
            </div>
