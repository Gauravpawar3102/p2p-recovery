    ...
    <div className='min-h-screen bg-neutral-50 dark:bg-neutral-950'>
      ...
      <main className='max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-6 sm:py-8 md:py-12 lg:py-16'>
          ...
          <a
            ...
            <div className='flex items-center justify-between gap-3'>
              <div className='text-left flex-1 min-w-0'>
                <h3 className='text-sm sm:text-base md:text-lg font-semibold text-neutral-900 dark:text-neutral-50 mb-1'>
                  Getting Started Guide
                </h3>
                <p className='text-xs sm:text-sm text-neutral-600 dark:text-neutral-400'>
                  Watch the video tutorial to learn how to use P2P Recovery
                </p>
              </div>
              <svg
                className='w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 text-neutral-400 group-hover:text-brand-500 dark:group-hover:text-brand-400 flex-shrink-0 transition-colors'
                fill='none'
                stroke='currentColor'
                viewBox='0 0 24 24'>
                <path
        ...
        <div className='mb-8 sm:mb-10 md:mb-12 flex justify-start'>
          <WalletConnect
            onP2PWalletChange={setP2pUserWallet}
            compact
                ...
                {getNetworksSortedByLabel().map((networkKey, index, array) => (
                  <button
                    ...
                    <div className='font-medium text-neutral-900 dark:text-neutral-50'>
                      {NETWORK_LABELS[networkKey]}
                    </div>
                    <div className='text-xs text-neutral-500 dark:text-neutral-400'>
                      Chain ID: {NETWORK_CHAIN_IDS[networkKey]}
                    </div>
                  </button>
                ))}
              </div>
        ...
        <div className='mb-8 md:mb-10'>
          <div className='mb-6 md:mb-8'>
            ...
            <p className='text-base text-neutral-600 dark:text-neutral-400'>
              View your smart account and transfer tokens from your P2P.ME Smart
              Account
            </p>
          </div>
          ...
          <div className='grid lg:grid-cols-2 gap-6 md:gap-8'>
            ...
            <div className='space-y-5 md:space-y-6'>
              ...
              <div className='hidden lg:block relative network-selector bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-xl p-5 md:p-6 shadow-soft'>
                ...
                {showNetworkDropdown && (
                  <div className='mt-3 bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-lg overflow-hidden shadow-medium'>
                    {getNetworksSortedByLabel().map(
                      (networkKey, index, array) => (
                        <button
                          key={networkKey}
                          onClick={() => handleNetworkChange(networkKey)}
                          className={`w-full px-4 py-3 text-left hover:bg-neutral-50 dark:hover:bg-neutral-700 transition-colors ${
                ...
                <div className='bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-xl p-8 md:p-12 shadow-soft'>
                  <div className='text-center'>
                    ...
                    <p className='text-sm text-neutral-600 dark:text-neutral-400'>
                      Please connect your wallet and wait for your Smart Account
                      address to be derived before you can transfer tokens.
                    </p>
                  </div>
                </div>
              )}
