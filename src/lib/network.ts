...
export const morphThirdwebChain = defineThirdwebChain({
  id: 2818,
  name: 'Morph',
  nativeCurrency: {
    decimals: 18,
...
export type NetworkConfig = {
  chain:
    | typeof monadMainnet
    | typeof bnbChain
    | typeof avalancheChain
    | typeof polygonChain
    | typeof optimismChain
    | typeof hyperliquidChain
    | typeof ethereumChain
    | typeof arbitrumChain
    | typeof mantleChain
    | typeof morphChain;
  bundlerUrl: string;
  entryPoint: Address;
...
export const NETWORKS: Record<NetworkKey, NetworkConfig> = {
  monad: {
    chain: monadMainnet,
    bundlerUrl:
      'https://api.pimlico.io/v2/143/rpc?apikey=pim_DgBeb1uoMpzzV4RG1Kxy6E',
  ...
  bnb: {
    chain: bnbChain,
    bundlerUrl:
      'https://api.pimlico.io/v2/56/rpc?apikey=pim_DgBeb1uoMpzzV4RG1Kxy6E',
    entryPoint: '0x5ff137d4b0fdcd49dca30c7cf57e578a026d2789' as Address,
    factoryAddress: '0xdE320c2E2b4953883f61774c006f9057A55B97D1' as Address,
  ...
  avax: {
    ...
    bundlerUrl:
      'https://api.pimlico.io/v2/43114/rpc?apikey=pim_DgBeb1uoMpzzV4RG1Kxy6E',
    entryPoint: '0x5ff137d4b0fdcd49dca30c7cf57e578a026d2789' as Address,
    factoryAddress: '0xdE320c2E2b4953883f61774c006f9057A55B97D1' as Address,
  ...
  polygon: {
    chain: polygonChain,
    bundlerUrl:
      'https://api.pimlico.io/v2/137/rpc?apikey=pim_DgBeb1uoMpzzV4RG1Kxy6E',
    entryPoint: '0x5ff137d4b0fdcd49dca30c7cf57e578a026d2789' as Address,
    factoryAddress: '0xdE320c2E2b4953883f61774c006f9057A55B97D1' as Address,
  ...
  optimism: {
    chain: optimismChain,
    bundlerUrl:
      'https://api.pimlico.io/v2/10/rpc?apikey=pim_DgBeb1uoMpzzV4RG1Kxy6E',
    entryPoint: '0x5ff137d4b0fdcd49dca30c7cf57e578a026d2789' as Address,
    factoryAddress: '0xdE320c2E2b4953883f61774c006f9057A55B97D1' as Address,
  ...
  hyperliquid: {
    ...
    bundlerUrl:
      'https://api.pimlico.io/v2/999/rpc?apikey=pim_DgBeb1uoMpzzV4RG1Kxy6E',
    entryPoint: '0x5ff137d4b0fdcd49dca30c7cf57e578a026d2789' as Address,
    factoryAddress: '0xdE320c2E2b4953883f61774c006f9057A55B97D1' as Address,
  ...
  ethereum: {
    chain: ethereumChain,
    bundlerUrl:
      'https://api.pimlico.io/v2/1/rpc?apikey=pim_DgBeb1uoMpzzV4RG1Kxy6E',
    entryPoint: '0x5ff137d4b0fdcd49dca30c7cf57e578a026d2789' as Address,
    factoryAddress: '0xdE320c2E2b4953883f61774c006f9057A55B97D1' as Address,
  ...
  arbitrum: {
    chain: arbitrumChain,
    bundlerUrl:
      'https://api.pimlico.io/v2/42161/rpc?apikey=pim_DgBeb1uoMpzzV4RG1Kxy6E',
    entryPoint: '0x5ff137d4b0fdcd49dca30c7cf57e578a026d2789' as Address,
    factoryAddress: '0xdE320c2E2b4953883f61774c006f9057A55B97D1' as Address,
  ...
  mantle: {
    chain: mantleChain,
    bundlerUrl:
      'https://api.pimlico.io/v2/5000/rpc?apikey=pim_DgBeb1uoMpzzV4RG1Kxy6E',
    entryPoint: '0x5ff137d4b0fdcd49dca30c7cf57e578a026d2789' as Address,
    factoryAddress: '0xdE320c2E2b4953883f61774c006f9057A55B97D1' as Address,
  ...
  morph: {
    chain: morphChain,
    bundlerUrl:
      'https://api.pimlico.io/v2/2818/rpc?apikey=pim_DgBeb1uoMpzzV4RG1Kxy6E',
    entryPoint: '0x5ff137d4b0fdcd49dca30c7cf57e578a026d2789' as Address,
    factoryAddress: '0xdE320c2E2b4953883f61774c006f9057A55B97D1' as Address,
    usdcAddress: '0xe34c91815d7fc18A9e2148bcD4241d0a5848b693' as Address,
    usdcDecimals: 6,
  },
};
...
export const THIRDWEB_CHAINS: Record<
  NetworkKey,
  ReturnType<typeof defineThirdwebChain>
> = {
  monad: monadChain,
